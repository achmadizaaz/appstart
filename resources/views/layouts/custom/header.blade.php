    ...
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box text-center">
                ...
                <a href="#" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="http://127.0.0.1:8000/assets/options/logo-sarpras-app.png" alt="logo-light" height="50">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    aria-labelledby="page-header-notifications-dropdown" style="width: 300px">
                    <div class="p-3">
